            ...
            <div class="recommended-slider">
                @foreach($all_products as $product)
                    <div class="image-block">
                        ...
                        <!-- NEW Overlay pre produkty vytvorene v poslednych 24 hodinach -->
